...
DATASETS: Dict[str, Callable[[str], None]] = {
    ...
    "kg-yago3-10-pykeen-mure-euclidean": lambda out_fn: knowledge_graph(out_fn, "YAGO3-10-Pykeen_MuRE-dim128-epoch256-KvsAll", "euclidean"),
    ...
    "kg-yago3-10-pykeen-rotate-euclidean": lambda out_fn: knowledge_graph(out_fn, "YAGO3-10-Pykeen_RotatE-dim128-epoch256-KvsAll", "euclidean"),
    ...
    "kg-fb15k-237-distmult-angular": lambda out_fn: knowledge_graph(out_fn, "FB15k-237-DistMult-dim128-epoch256-KvsAll", "angular"),
    ...
    "kg-nell-995-h25-pykeen-mure-angular": lambda out_fn: knowledge_graph(out_fn, "NELL-995-h25-Pykeen_MuRE-dim128-epoch256-KvsAll", "angular"),
    ...
    "kg-nell-995-h25-pykeen-rotate-angular": lambda out_fn: knowledge_graph(out_fn, "NELL-995-h25-Pykeen_RotatE-dim128-epoch256-KvsAll", "angular"),
    ...
    "kg-nell-995-h25-pykeen-mure-euclidean": lambda out_fn: knowledge_graph(out_fn, "NELL-995-h25-Pykeen_MuRE-dim128-epoch256-KvsAll", "euclidean"),
    ...
    "kg-nell-995-h25-pykeen-rotate-euclidean": lambda out_fn: knowledge_graph(out_fn, "NELL-995-h25-Pykeen_RotatE-dim128-epoch256-KvsAll", "euclidean"),
    ...
    "kg-wn18rr-pykeen-mure-angular": lambda out_fn: knowledge_graph(out_fn, "WN18RR-Pykeen_MuRE-dim128-epoch256-KvsAll", "angular"),
    "kg-wn18rr-pykeen-quate-angular": lambda out_fn: knowledge_graph(out_fn, "WN18RR-Pykeen_QuatE-dim128-epoch256-KvsAll", "angular"),
    "kg-wn18rr-pykeen-rotate-angular": lambda out_fn: knowledge_graph(out_fn, "WN18RR-Pykeen_RotatE-dim128-epoch256-KvsAll", "angular"),
    ...
    "kg-wn18rr-pykeen-mure-euclidean": lambda out_fn: knowledge_graph(out_fn, "WN18RR-Pykeen_MuRE-dim128-epoch256-KvsAll", "euclidean"),
    ...
    "kg-wn18rr-pykeen-rotate-euclidean": lambda out_fn: knowledge_graph(out_fn, "WN18RR-Pykeen_RotatE-dim128-epoch256-KvsAll", "euclidean"),
